...
GENE_MEDIAN_FILE = "/aaa/fionafyang/buddy1/lukatang/scMIL/scMIL-Geneformer/models/geneformer/gene_median_dictionary_gc95M.pkl"
TOKEN_DICTIONARY_FILE = "/aaa/fionafyang/buddy1/lukatang/scMIL/scMIL-Geneformer/models/geneformer/token_dictionary_gc95M.pkl"
ENSEMBL_MAPPING_FILE = "/aaa/fionafyang/buddy1/lukatang/scMIL/scMIL-Geneformer/models/geneformer/ensembl_mapping_dict_gc95M.pkl"
...
def sum_ensembl_ids(
    ...
    if file_format == "loom":
        ...
        # print(list(gene_token_dict.keys())[:100])
        # print(list(gene_token_dict.keys())[-100:])
        # sys.exit("code0")
        ...
        # print(data.var.ensembl_id)
        # first_10_items = list(gene_mapping_dict.items())[:10]
...
class TranscriptomeTokenizer:
    ...
    def tokenize_data(
        ...
        **Parameters:**
        ...
        # print(len(tokenized_cells[0]))
        # print(len(tokenized_cells[1]))
        ...
        output_path = (Path(output_directory) / (output_prefix + ".dataset"))
        # print("##############################################################", output_path)
        # print("##############################################################", output_prefix)
    ...
    def tokenize_anndata(self, adata_file_path, target_sum=10_000):
        ...
        for i in range(0, len(filter_pass_loc), self.chunk_size):
            ...
            # print(len(tokenized_cells[0]))
            # print(len(tokenized_cells[1]))
            # print(X_norm[0].data.shape)
            # print(X_norm[1].data.shape)
            # sys.exit("code0")
